...
def main():
    ...
    out_dir = Path("/home/tim/source/activity/prx-tg/results/prompt_tests")
    ...
    print("Generating prompts to test generalization...")
    for i, prompt in enumerate(prompts):
        ...
        # Explicitly set manual seed for reproducibility and variety
        ...
        with open(out_dir / f"test_prompt_{i+1}.txt", "w") as f:
            f.write(prompt)
