...
def create_comparison_collage(img_indices, category, out_path):
    arm_g_dir = f"experiments/asym-flow-ablation/runs/2026-05-21_1315/validation/step0005000/{category}/"
    arm_i_dir = f"experiments/2026-06-01_1224/validation/step0005000/{category}/"
    ...
    title = f"Step 5000 Comparison: {category.capitalize()}"
...
create_comparison_collage(indices_recon, "reconstruction", "arm_g_vs_i_recon_step5000.png")

indices_text = [0, 5, 10, 15]
create_comparison_collage(indices_text, "text_only", "arm_g_vs_i_text_step5000.png")
